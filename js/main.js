...
function comenzar() {
    ...
    const boxUsuario = document.querySelector('#box_Usuario');
    const nombreUsuario = document.createElement('p');
    boxUsuario.appendChild(nombreUsuario);
    nombreUsuario.textContent = `Hola ${USUARIO}! Prepárate para conocer a tu oponente.`;
    const ENEMIGO = prompt('Ingresa el nombre de tu oponente.').toUpperCase();
    console.log(`Tu oponente será ${ENEMIGO}!`);
    const boxEnemigo = document.querySelector('#box_Enemigo');
    const nombreEnemigo = document.createElement('p');
    boxEnemigo.appendChild(nombreEnemigo);
    nombreEnemigo.textContent = `Tu oponente será ${ENEMIGO}!`;
